<div class="col-2">
    {{-- verificamos que el usuario este autentificado --}}
    @auth
        {{-- verificamos que el usuario no sea profesor --}}

        @can('opt_for_course' , $course)
            {{-- verificamos que le usuario no sea admin y que no este suscrito --}}
            ...
            @else
                {{-- verificamos que le usuario no este inscrito en el curso--}}
                @can('inscribe' , $course)
